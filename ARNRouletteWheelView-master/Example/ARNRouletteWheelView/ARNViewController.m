...
//    self.rouletteWheelView = [[ARNRouletteWheelView alloc] initWithFrame:self.view.frame];
    self.rouletteWheelView = [[ARNRouletteWheelView alloc] initWithFrame:CGRectMake(self.view.frame.size.width/3, self.view.frame.size.height/2, self.view.frame.size.width/3*2, self.view.frame.size.height/2)];
    [self.rouletteWheelView setRadius:130];
